...
main() {
  ...
  setUpAll(() {
    _jsonSerializer = new CodegenSerializer.json()..addAllTypeCodecs(test_codegen_double_json_test_codecs);
    _typedJsonSerializer = new CodegenSerializer.typedJson()
      ..addAllTypeCodecs(test_codegen_double_json_test_codecs);
