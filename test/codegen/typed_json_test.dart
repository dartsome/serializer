...
Serializer _dateSerializer = new CodegenSerializer.typedJson()
  ..addAllTypeCodecs(test_codegen_typed_json_test_codecs)
  ..addAllTypeCodecs(test_codegen_models_test_codecs)
...
main() {
  ...
  group("Serialize", () {
    test("simple test", () {
      ...
      expect('{@type: TypedModelA, foo: toto}', serializer.toMap(a).toString());
      expect('{"@type":"TypedModelA","foo":"toto"}', serializer.encode(a));
      expect({"@type": "TypedModelA", "foo": "toto"}, serializer.toMap(a));
    });
    ...
    test("list", () {
      ...
      expect('[{"@type":"TypedModelA","foo":"toto"},{"@type":"TypedModelA","foo":"bar"}]', json);
    });

    test("inner list 1", () {
      List<TypedModelA> list = [new TypedModelA("toto"), new TypedModelA()];
      TypedModelD test = new TypedModelD(list);
      String json = serializer.encode(test);
    ...
    test("inner list 2", () {
      ...
      expect('{"@type":"TypedModelE","tests":["toto","bar"]}', serializer.encode(e));
    });

    test("inner class non-serializable", () {
      TypedModelB b = new TypedModelB();
      expect('{"@type":"TypedModelB","toto":"tata"}', serializer.encode(b));
      expect({"@type": "TypedModelB", "toto": "tata"}, serializer.toMap(b));
    });

    test("inner class serializable", () {
      TypedModelC c = new TypedModelC();
      expect('{"@type":"TypedModelC","foo":{"@type":"TypedModelA","foo":"bar"},"plop":"titi"}', serializer.encode(c));
      expect({
        "@type": "TypedModelC",
    ...
    test("list class non-serializable", () {
      ...
      String json = serializer.encode(list);
      expect('[{"@type":"TypedModelB","toto":"tata"},{"@type":"TypedModelB","toto":"tata"}]', json);
    });
    ...
    test("Datetime", () {
      ...
      expect({"@type": "TypedDate", "date": "2016-01-01T00:00:00.000"}, serializer.toMap(date));
   ...
   /* test("Max Superclass", () { fixme: issue to find @serializable on all supertypes and all mixins
    ...
    test("Ignore attribute", () {
      ...
      expect('{"@type":"TypedWithIgnore","a":"1337","b":"42"}', serializer.encode(_ignore));
    ...
    test("dynamic", () {
      ...
      pet = new Pet()
        ...
        ..animal = cat;
      expect(
          '{"@type":"Pet","name":"Pet","animal":{"@type":"Cat","name":"Felix","mew":false}}', serializer.encode(pet));

      pet = new Pet()
        ..name = "Pet"
        ..animal = dog;
      expect(
          '{"@type":"Pet","name":"Pet","animal":{"@type":"Dog","name":"Medor","bark":true}}', serializer.encode(pet));
    });
    ...
    test("with typeInfo", () {
      ...
      pet = new PetWithTypeInfo()
        ..name = "Pet"
        ..animal = cat;
      expect('{"@type":"PetWithTypeInfo","name":"Pet","animal":{"@type":"Cat","name":"Felix","mew":false}}',
          serializer.encode(pet));

      pet = new PetWithTypeInfo()
        ..name = "Pet"
        ..animal = dog;
      expect('{"@type":"PetWithTypeInfo","name":"Pet","animal":{"@type":"Dog","name":"Medor","bark":true}}',
          serializer.encode(pet));
    });
  });
  ...
  group("Deserialize", () {
    test("simple test - fromJson", () {
      TypedModelA a = serializer.decode('{"@type":"TypedModelA","foo":"toto"}');
    ...
    test("simple test - fromMap - without type field", () {
      TypedModelA a = serializer.fromMap({"foo": "toto"}, type: TypedModelA);
    ...
    test("simple test - fromMap", () {
      TypedModelA a = serializer.fromMap({"@type": "TypedModelA", "foo": "toto"});
    ...
    test("list - fromList", () {
      List list = serializer.fromList([
        {"@type": "TypedModelA", "foo": "toto"},
        {"@type": "TypedModelA", "foo": "bar"}
      ]);
    ...
    test("inner list 2", () {
      TypedModelE test = serializer.decode('{"@type":"TypedModelE","tests":["toto","bar"]}');
    ...
    test("inner class serializable", () {
      TypedModelC c =
          serializer.decode('{"@type":"TypedModelC","foo":{"@type":"TypedModelA","foo":"toto"},"plop":"bar"}');
    ...
    test("Datetime", () {
      TypedDate date = serializer.decode('{"@type":"TypedDate","date":"2016-01-01T00:00:00.000"}');
    ...
    test("Serialized name", () {
      TypedModelRenamed _model = serializer.decode('{"@type":"TypedModelRenamed","new":"Hello","tests":["A","B","C"]}');
  ...
  group("Complex", () {
    test("Serialize", () {
      var complex = new TypedComplex()
        ...
        ..ignores = [
          new TypedWithIgnore("1337A", "42A", "ThisIsASecretA"),
          new TypedWithIgnore("1337B", "42B", "ThisIsASecretB")
        ]
        ...
        ..ignoreSet = {
          "A": new TypedWithIgnore("1337A", "42A", "ThisIsASecretA"),
          "B": new TypedWithIgnore("1337B", "42B", "ThisIsASecretB")
        }
        ..listInnerMap = {
          "test": ["123456"]
        };
  ...
  group("Mixin", () {
    ...
    test("Deserialize", () {
      Mixin mixin = serializer.decode('{"@type":"Mixin","a":"A","b":"B","m2":"M2","m1":"M1"}');
 ...
 /* group("Referenceable", () {
    test("Serialize", () {
      ...
      expect(serializer.encode(addressManager),
          '{"@type":"Address","id":1337,"location":"Somewhere","owner":{"@type":"Employee","id":43}}');
      expect(serializer.encode(addressEmployee),
          '{"@type":"Address","id":1338,"location":"Somewhere else","owner":{"@type":"Employee","id":42}}');
      expect(serializer.encode(manager),
          '{"@type":"Employee","id":43,"name":"Alice Doo","address":{"@type":"Address","id":1337}}');
