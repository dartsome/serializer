...
import '../codecs/type_codec.dart';

bool isPrimaryType(Type obj) => obj == num || obj == String || obj == bool || obj == int || obj == double;
...
class Serializer extends _Serializer {
  ...
  factory Serializer.json({Map<String, TypeCodec> typesCodecs}) {
    return new Serializer(typesCodecs: typesCodecs, codec: json);
  }

  factory Serializer.typedJson({Map<String, TypeCodec> typesCodecs}) {
    return new Serializer(typesCodecs: typesCodecs, codec: json, useTypeInfo: true);
  }
  ...
  Map<String, dynamic> toMap(Object input, {bool useTypeInfo, bool withTypeInfo}) =>
      toPrimaryObject(input, useTypeInfo: useTypeInfo, withTypeInfo: withTypeInfo) as Map<String, dynamic>;
  ...
  Object _fromMap(Map map, {Type type, List<Type> mapOf, bool useTypeInfo, bool withTypeInfo}) {
    ...
    if (type == Map) {
      ...
      map.forEach((key, value) => data[key.toString()] =
          embedType == null && useTypeInfo == null ? value : _decodeValue(value, embedType, useTypeInfo: useTypeInfo));
      return data;
    }
